		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC YOUNG-MM] 재고리스트 조회",
									"targetURL": "#cl3syncyoungmmliststock-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungmmliststock-display": {
								"semanticObject": "cl3syncyoungmmliststock",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.mm.list.stock",
									"url": sap.ui.require.toUrl("cl3/syncyoung/mm/list/stock")
								}
							}
						}
					}

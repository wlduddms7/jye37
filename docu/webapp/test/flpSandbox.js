		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC YOUNG-MM] 자재문서",
									"targetURL": "#cl3syncyoungmmdocdocu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungmmdocdocu-display": {
								"semanticObject": "cl3syncyoungmmdocdocu",
								"action": "display",
								"description": "[SYNC YOUNG-MM] 자재문서",
								"title": "[SYNC YOUNG-MM] 자재문서",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.mm.doc.docu",
									"url": sap.ui.require.toUrl("cl3/syncyoung/mm/doc/docu")
								}
							}
						}
					}
